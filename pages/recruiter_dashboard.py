...
#                             from utils.file_handler import get_resume_path, resume_exists
                            
#                             if resume_exists(app['resume_filename']):
#                                 resume_path = get_resume_path(app['resume_filename'])
                                
#                                 with open(resume_path, 'rb') as file:
#                                     st.download_button(
#                                         label="Download Resume",
#                                         data=file,
#                                         file_name=f"{app['user_name']}_resume.{app['resume_filename'].split('.')[-1]}",
