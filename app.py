...
# # #         with col1:
# # #             st.markdown("### ðŸ’¼ JobHub")
        
# # #         with col2:
# # #             st.markdown(f'<span class="user-badge">{user["name"]}</span>', unsafe_allow_html=True)
...
# # #             else:
# # #                 success, message = signup(email, password, name, role)
...
# #             with col2:
# #                 st.markdown(f'<span class="user-badge">{user.get("name", "User")}</span>', unsafe_allow_html=True)
